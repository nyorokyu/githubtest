...
class CreateCsvClientTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('csv_client', function (Blueprint $table) {
            $table->id();
            $table->integer('clinrt_id')->unsigned()->comment('クライアントID');
    ...
    {
        Schema::dropIfExists('csv_client');
    }
}
