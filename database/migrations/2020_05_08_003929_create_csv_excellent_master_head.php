...
class CreateCsvExcellentMasterHead extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('csv_excellent_master_head', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('csv_excellent_master_head');
    }
}
