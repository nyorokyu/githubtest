...
@section('title', 'M＆A投稿一覧')
@include('admin.layouts.head')

@section('h1', 'M&A投稿一覧')
@section('header_nav')
  <p><a href="{{ route('admin.ma.index') }}" class="btn">新規追加</a></p>
      ...
      <tbody>
        @foreach($list as $data)
          <tr>
            ...
            <td class="w-200">
              <form action="{{route('admin.list_ma.destroy', $data->id)}}" method="POST" class="form">
                @csrf
                @method('DELETE')
                <div class="box-flex">
                  <a href="{{route('admin.ma.index', $data->id)}}" class="btn">変更</a>
