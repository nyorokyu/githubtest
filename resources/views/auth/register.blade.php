                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="name" class="col-md-4 col-form-label text-md-right">会社名<span class="txt-s">または</span>氏名</label>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="tel" type="tel" class="form-control @error('tel') is-invalid @enderror" name="tel" value="{{ old('tel') }}" autocomplete="tel">
                        ...
                        <div class="form-group row">
                            ...
                            <div id="role" class="col-md-6">
                              <select name="role" class="selectbox">
                                ...
                                <option value="5">見積作成者</option>
                                <option value="10" selected>一般会員（見積依頼者）</option>
                              </select>
                            </div>
                        </div>
